#!/bin/bash
# Finish remaining starting pitcher boxscores for 2019-2009

echo "==================================================================="
echo "Finishing MLB Starting Pitcher Boxscores (2019-2009)"
echo "==================================================================="
echo ""

# Run each remaining year sequentially (2019 down to 2009)
for year in 2019 2018 2017 2016 2015 2014 2013 2012 2011 2010 2009; do
    echo "-------------------------------------------------------------------"
...
echo "==================================================================="
echo "All years (2019-2009) complete!"
echo "==================================================================="
echo ""
echo "Final Summary (All Years):"
