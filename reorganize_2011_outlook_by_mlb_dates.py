...
print("="*60)
print("STEP 1: Loading MLB boxscores")
print("="*60)
...
print("\n" + "="*60)
print("STEP 2: Loading all BDL game outlook data")
print("="*60)
...
print("\n" + "="*60)
print("STEP 3: Adding game_pk and MLB date to outlook")
print("="*60)
...
print("\n" + "="*60)
print("STEP 4: Reorganizing files by MLB date")
print("="*60)
...
for mlb_date, group_df in outlook_df.groupby('mlb_date'):
    ...
    if mlb_date in game_pk_order_by_date:
        ...
        if len(ordered_rows) > 0:
            ...
            # Write to file
            outlook_file = f'data/2011_data/mlb_data/raw/bdl_data/game_outlook/game_outlook_{mlb_date}.csv'
...
# Final count
final_count = sum(len(pd.read_csv(f)) for f in glob.glob('data/2011_data/mlb_data/raw/bdl_data/game_outlook/*.csv'))
print(f"\n{'='*60}")
print(f"Final outlook game count: {final_count}")
print(f"Expected: 2430")
print(f"Match: {'✓' if final_count == 2430 else '✗'}")
print("="*60)
