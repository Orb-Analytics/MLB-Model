"""
Walk-Forward Validation - CatBoost Only
"""
...
print("="*100)
print("🔄 WALK-FORWARD VALIDATION - CATBOOST ONLY")
print("="*100)
print()
...
print("Starting CatBoost walk-forward validation...")
print()
...
print()
print(f"✓ CatBoost walk-forward complete! {len(all_predictions):,} predictions")

# Save results
predictions_df = pd.DataFrame(all_predictions)
predictions_df.to_csv('modeling/walkforward_results/catboost_predictions.csv', index=False)
print(f"✓ Saved: modeling/walkforward_results/catboost_predictions.csv")
print()
