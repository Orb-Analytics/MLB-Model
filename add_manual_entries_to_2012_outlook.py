...
print("="*70)
print("Adding manual entries to 2012 game outlook")
print("="*70)

# Read the manual entries
manual_entries = pd.read_csv('manual_entries_2012.csv')
print(f"Loaded {len(manual_entries)} manual entries")

# All entries are for the same date
date = '2012-10-03'
outlook_file = f'data/2012_data/mlb_data/raw/bdl_data/game_outlook/game_outlook_{date}.csv'
...
if os.path.exists(outlook_file):
    ...
    boxscore_file = f'data/2012_data/mlb_data/raw/boxscores/boxscores_{date}.csv'
